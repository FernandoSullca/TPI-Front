...
const routes: Routes = [
  ...
  {
    path: "perfil",
    canActivate: [IsLoggedInGuard], component: PerfilSubjetivoComponent
  },
  {
    path: "perfil-inversor",
    canActivate: [IsLoggedInGuard], component: TestPerfilSubjetivoComponent
  },

  {
    path: 'perfil-inversor-resultado', 
    canActivate: [IsLoggedInGuard], component: PerfilSubjetivoResultadoComponent
  },
  {
    path: 'dashboard',
    canActivate: [IsLoggedInGuard ],
    ...
    children: [
      ...
      { path: 'precios', component: PricePanelComponent },
      {
        ...
        component: PerfilInversorObjetivoPresentacionComponent
      },
